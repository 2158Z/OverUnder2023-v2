...
enum drive_set {ZERO_TRACKER_NO_ODOM, ZERO_TRACKER_ODOM, TANK_ONE_ENCODER, TANK_ONE_ROTATION, TANK_TWO_ENCODER, TANK_TWO_ROTATION, HOLONOMIC_TWO_ENCODER, HOLONOMIC_TWO_ROTATION};
...
public: 
  drive_set drive_setup = ZERO_TRACKER_NO_ODOM;
  MotorGroup DriveL;
  MotorGroup DriveR;
  Imu Gyro;
  Motor DriveLF;
  ...
  Rotation E_ForwardTracker;
  Rotation E_SidewaysTracker;
  ...
  void createDrive(MotorGroup DriveL, MotorGroup DriveR, int gyro_port, float wheel_diameter, float wheel_ratio, float gyro_scale, Motor DriveLF_port, Motor DriveRF_port, Motor DriveLB_port, Motor DriveRB_port, int ForwardTracker_port, float ForwardTracker_diameter, float ForwardTracker_center_distance, int SidewaysTracker_port, float SidewaysTracker_diameter, float SidewaysTracker_center_distance);
  ...
  void position_track();
  static void position_track_task();
  Task odom_task;
